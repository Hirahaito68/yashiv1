...
{title: `${emot} SEWA Jaya-Botz`, rowId: ".sewa", },
...
//------------------ DOCUMENT
await conn.send3ButtonImg(m.chat, await (await fetch('https://i.ibb.co/7kSnyh8/IMG-20221111-104556.jpg')).buffer(), cap1, text.trim(), 'OWNER', '.owner', 'SEWA BOT', '.sewa', 'S & K', '.rules',  m, {
      quoted: fliveLoc,  
